...
//safer
if let unwrapZ = z {
    print("UpwrapZ = \(unwrapZ)")
}

//upwrap option 2
//unsafe, may cause crash as z maybe nil
print("UpwrapZ = \(z!)")

// Example 2
class AnotherViewController: UIViewController {
    //three ways to declear object
    var anotherButton2: UIButton = UIButton() //init here
    var anotherButton: UIButton? //optional init, =nil now, need to be upwrapped first everywhere using this
    var anotherBUtton3: UIButton! //know that this value gonna be init somewhere else (already unwrapped)
}
