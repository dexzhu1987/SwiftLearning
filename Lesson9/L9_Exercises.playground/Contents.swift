...
let sortedAverages2 = battingAverages.sorted(by:{ $0 > $1 })
print(sortedAverages)
print(sortedAverages2)
...
let result2 = numbersAsStrings.filter({
    Int($0)! % 12 == 0
})
print(result)
//: __Problem 4__
...
let newSize = particleSizesInMicrons.filter({ $0 < 20 })
print(newSize)
//: __Problem 5__
//:
...
let pricesInDollar = pricesInRupees.map({Int(Double($0) *  0.015)})
print(pricesInDollar)
//: __Problem 6__
//:
